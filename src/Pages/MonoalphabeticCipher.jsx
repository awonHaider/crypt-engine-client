  ...
  const handleEncrypt = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/api/v1/encrypt/monoalphabetic",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <div className="api-section pl-[2rem] mb-[2rem] md:pl-[8rem] md:pt-[5rem]">
        <h3 className=" mb-6 text-xl font-bold">Monoalphabetic Cipher</h3>
        ...
        >
          <input
            className="text-sm w-full bg-transparent outline-none"
            placeholder="Enter a 26-letter alphabet key!"
            type="text"
            value={key}
